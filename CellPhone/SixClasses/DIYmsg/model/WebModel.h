...
+ (void)asyncDownloadWithParams:(NSDictionary *)param
               ...
               successBlock:(void (^)(AFHTTPRequestSerializer *operation, id responseObject))successBlock
               errorBlock:(void (^)(AFHTTPRequestSerializer *operation, NSError *error))errorBlock
