                        ...
                        CFDictionaryRef userInfo)
{
    ...
    NSDictionary *info = (__bridge NSDictionary *)(userInfo);
        ...
        Class FTDeviceSupport = NSClassFromString(@"TUCall");
        id si = [FTDeviceSupport new];
    
        NSLog(@"callUUID-- %@",[si valueForKey:@"callUUID"]);
     NSLog(@" alerting-- %@",[si valueForKey:@"alerting"]);
      NSLog(@"audioCategory-- %@",[si valueForKey:@"audioCategory"]);
      NSLog(@"callHistoryIdentifier-- %@",[si valueForKey:@"callHistoryIdentifier"]);
      NSLog(@"callStats-- %@",[si valueForKey:@"callStats"]);
      NSLog(@"connected-- %@",[si valueForKey:@"connected"]);
    NSLog(@"outgoing -- %@",[si valueForKey:@"outgoing"]);
